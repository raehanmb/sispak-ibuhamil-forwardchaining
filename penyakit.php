...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add'])) {
        ...
        $nama = $_POST['nama'];
        $solusi = $_POST['solusi'];
        $sql = "INSERT INTO penyakit (kode, nama, solusi) VALUES ('$kode', '$nama', '$solusi')";
        ...
        $nama = $_POST['nama'];
        $solusi = $_POST['solusi'];
        $sql = "UPDATE penyakit SET kode='$kode', nama='$nama', solusi='$solusi' WHERE id=$id";
        mysqli_query($conn, $sql);
...
<body>
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_assoc($penyakit)) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <button onclick="editPenyakit(<?php echo $row['id']; ?>, '<?php echo $row['kode']; ?>', '<?php echo $row['nama']; ?>', '<?php echo $row['solusi']; ?>')" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal">Edit</button>
    ...
    <script>
        ...
        function editPenyakit(id, kode, nama, solusi) {
